...
namespace SaristhBookstore.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,BookId,Description")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,BookId,Description")] Comment comment)
        {
            if (ModelState.IsValid)
            {
